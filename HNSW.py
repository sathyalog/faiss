...
# HNSW will not create clusters and create graphs. This HNSW will be used in production systems
#no of nodes creaeted in the graph in between range 16-64
M=32
index = faiss.IndexHNSWFlat(1536, M)  # 1536 is the dimension of the openai/text-embedding-3-small model, if you use a different model you will find different dimensions
